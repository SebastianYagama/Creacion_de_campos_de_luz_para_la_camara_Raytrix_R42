...
#
#   Este algoritmo lee una foto en blanco, detecta los micro lentes de esta foto, los clasifica 
#dependiendo su tipo y muestra el numero de lentes detectados con sus porcentajes de error, 
#con esto se puede saber que tan efectivo será el algoritmo usando esta foto en blanco para la 
#reconstrucción y la creación de los campos de luz
#
#
#Entradas:
#   -   Imagen en blanco.
...
#
#Salidas:
#   -   Visualización y guardado de grafica para la clasificación de cada lente hecha por K-Means.
#   -   Numero de micro lentes totales y para cada tipo hallados con su respectivo error
#   -   Recomendación del tamaño de la matriz a usar en la creación de los campos de luz
#
#
#Librerias a usar
import cv2
...
path1 = r'C:\Users\sebas\OneDrive\Escritorio\1. Tesis Plenoptica\Codigo light field\Fotos en blanco\Foto_en_blanco_lente_59872.jpg'
